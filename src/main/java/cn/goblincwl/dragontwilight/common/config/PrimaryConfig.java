...
@EnableJpaRepositories(
        ...
        basePackages = {
                "cn.goblincwl.dragontwilight.repository.primary",
                "cn.goblincwl.dragontwilight.yggdrasil.repository"
        })
public class PrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages(
                        "cn.goblincwl.dragontwilight.entity.primary",
                        "cn.goblincwl.dragontwilight.yggdrasil.entity"
                ) //设置实体类所在位置
